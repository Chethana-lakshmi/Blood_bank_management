...
import { Droplets, Home, Droplet, Bell, User, Menu, X, LogOut } from 'lucide-react'
import { useAuth } from '../context/AuthContext'
import NotificationBell from '../components/ui/NotificationBell'
import DonorBottomNav from '../components/layout/DonorBottomNav'
...
export default function DonorLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {mobileDrawer && (
        <div className="fixed inset-0 z-40 bg-black/40 md:hidden" onClick={() => setMobileDrawer(false)} />
      )}
