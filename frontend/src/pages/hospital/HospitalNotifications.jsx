  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-gray-900">Hospital Notifications</h1>
          <p className="text-sm text-gray-500">Alerts regarding blood request approvals and fulfillment</p>
        </div>
      ...
      {notifications.length === 0 ? (
        <EmptyState
          ...
          description="You will be notified when your blood requests are approved or updated."
        />
      ) : (
