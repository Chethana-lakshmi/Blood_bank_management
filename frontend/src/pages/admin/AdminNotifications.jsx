  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-gray-900">Admin System Alerts</h1>
          <p className="text-sm text-gray-500">System notifications for requests, donations, and inventory levels</p>
        </div>
      ...
      {notifications.length === 0 ? (
        <EmptyState
          ...
          description="All system activities are current. Notifications for low inventory and requests will show here."
        />
      ) : (
