...
const navItems = [
  ...
  { to: '/hospital/search-blood', icon: Search, label: 'Search' },
  { to: '/hospital/requests', icon: ClipboardList, label: 'Requests' },
  { to: '/hospital/notifications', icon: Bell, label: 'Alerts', hasCount: true },
...
export default function HospitalBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-gray-100 safe-area-bottom md:hidden">
      <div className="flex items-center justify-around h-[60px] pb-safe px-1">
